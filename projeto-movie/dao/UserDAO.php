...
class UserDAO implements UserDAOInterface
{
    ...
    public function update(User $user, $redirect = true)
    {
        ...
        if ($redirect) {
            $this->message->setMessage("Updated data.👏.", "success", "editprofile.php");
        }
    }
    public function verifyToken($protected = false)
    {
        if (!empty($_SESSION["token"])) {
            ...
            if ($user) {
                ...
                $this->message->setMessage("Authenticate to access the page!", "error", "index.php");
            }
        } else if ($protected) {
            $this->message->setMessage("Authenticate to access the page!", "error", "index.php");
        }
    ...
    public function destroyToken()
    {
        ...
        $this->message->setMessage("Check back often.", "success", "index.php");
    }
